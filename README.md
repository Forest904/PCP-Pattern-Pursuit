...
- Drag tiles into the solution slots to build an ordered stack. Slots can repeat tiles; the tray keeps a reference copy so you can reorder and reuse freely.
